...
OQuare Ontology, named oquo-oquare (https://purl.archive.org/oquo-oquare), provides detailed information about quality metrics and the static scale defined within the OQuaRE framework. The ontology, `oquo-oquare` import the oquo-core, from the [**Ontology QUality Ontology (OQUO)**](https://github.com/tecnomod-um/oquo), a modular ontology designed to semantically represent quality models based on OQuaRE Framework. OQUO includes:
